...
async function findTemplate(templatePath) {
    ...
    const err = new Error(`Template not found. Tried:\n - ${tried}`);
 ...
 */
export async function sendTemplatedEmail(templatePath, data, mailOptions) {
    try {
